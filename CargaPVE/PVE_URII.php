...
function fetchDataForTable($conn) {
    $sql = "SELECT Formulario, Tipologia, Fuente, ReporteAsociado, FechaDeCreacion FROM entidad_encabezado WHERE Fuente = 'URII' ORDER BY FechaDeCreacion DESC LIMIT 10";
...
<head>
  ...
  <!-- JS -->
  <script src="JS/mainPageURII.js"></script>
...
<body class="bg-secondary" style="background-image: url('../CSS/Images/BackGround.png'); background-size: cover; background-attachment: fixed;">
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <?php if ($usergroup == 'ADMINISTRADOR'): ?>
        <div style="position: absolute; left: 0;">
            <button type="button" id="VolverButton" class="btn btn-light btn-lg mx-3" onclick="window.location.href='../index.php'">
