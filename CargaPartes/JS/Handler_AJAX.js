...
function guardarCambiosSecuestro() {
    guardarCambios('CargarSecuestro', 'insertarDatosSecuestro');
}
...
function eliminarSecuestro() {
    eliminarEntidad('ClavePrimaria', 'eliminarSecuestro');
}
